        ...
        <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-7 lg:h-full xl:col-span-6">
          ...
          <div className="hidden lg:relative lg:block lg:p-12">
            ...
            <p className="mt-4 leading-relaxed text-white/90">
              En el mundo de DevOps, la agilidad es nuestra superpotencia, y la
              mejora continua nuestro combustible.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-xl lg:max-w-3xl">
            <div className="relative -mt-16 block lg:hidden">
              ...
              <p className="mt-4 leading-relaxed text-gray-500">
                En el mundo de DevOps, la agilidad es nuestra superpotencia, y
                la mejora continua nuestro combustible.
              </p>
            </div>
